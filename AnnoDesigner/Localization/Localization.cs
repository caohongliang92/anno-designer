        ...
        public static void Init(ICommons commons)
        {
            ...
            TranslationsRaw = new Dictionary<string, IDictionary<string, string>>()
            {
                ["eng"] = new Dictionary<string, string>()
                {
                    ...
                    ["VersionCheckErrorMessage"] = $"Error checking version.{Environment.NewLine}More information can be found in the log.",
                    ["VersionCheckErrorTitle"] = "Version check failed.",
                    ["EnableAutomaticUpdateCheck"] = "Enable automatic update check on startup",
                    ["ContinueCheckingForUpdates"] = $"Do you want to continue checking for a new version on startup?{Environment.NewLine}{Environment.NewLine}This option can be changed via Tools -> Preferences -> Update Settings.",
                    ["ContinueCheckingForUpdatesTitle"] = "Continue checking for updates?",
                    ...
                    ["ExportImageError"] = "Something went wrong while exporting the image.",
                    ...
                    ["DeleteObjectUnderCursor"] = "Delete object under cursor",
                    ["Licenses"] = "Licenses",
                    ...
                    ["View"] = "View",
                    ["SaveUnsavedChanges"] = "Save unsaved changes?",
                ...
                ["ger"] = new Dictionary<string, string>()
                {
                    ...
                    ["VersionCheckErrorMessage"] = $"Etwas ist bei der Updateprüfung schiefgegangen.{Environment.NewLine}Weitere Informationen finden Sie im Protokoll.",
                    ...
                    ["OriginalHomepage"] = "Original Webseite",
                    ["ProjectHomepage"] = "Projekt Webseite",
                    ...
                    ["ExportImageError"] = "Beim Exportieren des Bildes ging etwas schief.",
                    ...
                    ["DeleteObjectUnderCursor"] = "Objekt unter Mauszeiger löschen",
                    ["Licenses"] = "Lizenzen",
                    ...
                    ["LoadingPresetsFailed"] = "Das Laden der Gebäudevorlagen ist fehlgeschlagen.",
                    ["LoadingIconNamesFailed"] = "Das Laden der Iconnamen ist fehlgeschlagen.",
                    ...
                    ["View"] = "Ansicht",
                    ["SaveUnsavedChanges"] = "Änderungen speichern?",
                ...
                ["fra"] = new Dictionary<string, string>()
                {
                    ...
                    ["VersionCheckErrorMessage"] = $"Quelque chose s'est mal passé lors de la vérification de la version d'erreur.{Environment.NewLine}Plus d'informations peuvent être trouvées dans le journal. exportation de l'image.",
                    ["VersionCheckErrorTitle"] = "La vérification de la version a échoué.",
                    ["EnableAutomaticUpdateCheck"] = "Activer les mises à jour automatique au démarrage",
                    ["ContinueCheckingForUpdates"] = $"Vous souhaitez continuer à vérifier si une nouvelle version est disponible au démarrage?{Environment.NewLine}{Environment.NewLine} Cette option peut être modifiée via Outils -> Préférences -> Mise à jour des paramètres.",
                    ["ContinueCheckingForUpdatesTitle"] = "Continuer à vérifier les mises à jour ?",
                    ...
                    ["ExportImageError"] = "Quelque chose s'est mal passé lors de l'exportation de l'image.",
                    ...
                    ["DeleteObjectUnderCursor"] = "Supprimer l'objet sous le curseur",
                    ["Licenses"] = "Licences",
                    ...
                    ["View"] = "Voir",
                    ["SaveUnsavedChanges"] = "Sauvegarder les modifications non sauvegardées ?",
                ...
                {
                    ["File"] = "Archivo",
                    ["NewCanvas"] = "Nuevo proyecto",
                    ["Open"] = "Abrir",
                    ["Save"] = "Guardar",
                    ["SaveAs"] = "Guardar como",
                    ["CopyLayoutToClipboard"] = "Copiar diseño al portapapeles como JSON",
                    ["LoadLayoutFromJson"] = "Cargar diseño desde JSON",
                    ["Exit"] = "Salir",
                    ["Extras"] = "Extras",
                    ["Normalize"] = "Normalizar",
                    ["ResetZoom"] = "Restablecer zoom",
                    ["RegisterFileExtension"] = "Registrar extensión de archivo",
                    ["RegisterFileExtensionSuccessful"] = "El registro de la extensión del archivo se ha realizado correctamente.",
                    ["UnregisterFileExtension"] = "Eliminar extensión de archivo",
                    ["UnregisterFileExtensionSuccessful"] = "Se ha eliminado el registro de la extensión de archivo correctamente.",
                    ["Successful"] = "Éxito",
                    ["Export"] = "Exportar",
                    ["ExportImage"] = "Exportar como imagen",
                    ["UseCurrentZoomOnExportedImage"] = "Utilizar el zoom actual en la imagen exportada",
                    ["RenderSelectionHighlightsOnExportedImage"] = "Renderizar la selección en la imagen exportada",
                    ["Language"] = "Idioma",
                    ["ManageStats"] = "Gestionar estadísticas",
                    ["ShowStats"] = "Mostrar estadísticas",
                    ["BuildingCount"] = "Número de edificios",
                    ["Help"] = "Ayuda",
                    ["Version"] = "Versión",
                    ["FileVersion"] = "Versión del archivo",
                    ["PresetsVersion"] = "Versión de las plantillas",
                    ["CheckForUpdates"] = "Comprobar actualizaciones",
                    ["VersionCheckErrorMessage"] = $"Error al comprobar la versión.{Environment.NewLine}Puedes encontrar más información en el registro.",
                    ["VersionCheckErrorTitle"] = "La comprobación de la versión ha fallado.",
                    ["EnableAutomaticUpdateCheck"] = "Activar actualizaciones automáticas al inicio",
                    ["ContinueCheckingForUpdates"] = $"¿Quieres seguir buscando nuevas versiones al inicio?{Environment.NewLine}{Environment.NewLine}Esta opción se puede cambiar en Herramientas -> Preferencias -> Configuración de actualizaciones.",
                    ["ContinueCheckingForUpdatesTitle"] = "¿Seguir comprobando si hay actualizaciones?",
                    ["GoToProjectHomepage"] = "Ir a la página del proyecto",
                    ["OpenWelcomePage"] = "Abrir la página de bienvenida",
                    ["AboutAnnoDesigner"] = "Acerca de Anno Designer",
                    ["ShowGrid"] = "Mostrar cuadrícula",
                    ["ShowLabels"] = "Mostrar etiquetas",
                    ["ShowIcons"] = "Mostrar iconos",
                    ["ShowTrueInfluenceRange"] = "Mostrar alcance de la influencia real",
                    ["ShowInfluences"] = "Mostrar influencias",
                    ["BuildingSettings"] = "Opciones de construcción",
                    ["Size"] = "Tamaño",
                    ["Color"] = "Color",
                    ["Label"] = "Etiqueta",
                    ["Icon"] = "Icono",
                    ["InfluenceType"] = "Tipo de influencia",
                    ["None"] = "Ninguno",
                    ["Radius"] = "Radio",
                    ["Range"] = "Zona de detección",
                    ["Distance"] = "Distancia",
                    ["Both"] = "Ambos",
                    ...
                    ["Road"] = "Rutas",
                    ["PlaceBuilding"] = "Colocación de edificios",
                    ["Search"] = "Filtro",
                    ["SearchToolTip"] = "ESC para borrar el texto de búsqueda",
                    ["SearchPlaceholder"] = "Escribe aquí el nombre de un edificio",
                    ["TitleAbout"] = "Acerca de",
                    ["BuildingLayoutDesigner"] = "Un diseñador de edificios para la serie Anno de Ubisoft",
                    ["Credits"] = "Créditos",
                    ["OriginalApplicationBy"] = "Aplicación original de",
                    ["BuildingPresets"] = "Plantillas de edificios",
                    ["CombinedForAnnoVersions"] = "Combinación de plantillas de edificios para",
                    ["AdditionalChanges"] = "Cambios adicionales de los colaboradores en Github",
                    ["ManyThanks"] = "Muchas gracias a todos los usuarios que han contribuido a este proyecto.",
                    ["VisitTheFandom"] = "¡No dejes de visitar las páginas de Fandom de Anno!",
                    ["OriginalHomepage"] = "Página web original",
                    ["ProjectHomepage"] = "Página del proyecto",
                    ["GoToFandom"] = "Ir a Fandom",
                    ["Close"] = "Cerrar",
                    ["StatusBarControls"] = "Controles del ratón: izquierdo - colocar, seleccionar, mover // derecho - dejar de colocar, eliminar // ambos - mover todo // doble clic - copiar // rueda - zoom // clic-rueda - rotar.",
                    ["StatusBarItemsOnClipboard"] = "Elementos en el portapapeles",
                    ["StatNothingPlaced"] = "No se ha colocado nada",
                    ["StatBoundingBox"] = "Zona de delimitación",
                    ["StatMinimumArea"] = "Superficie mínima",
                    ["StatSpaceEfficiency"] = "Uso del espacio",
                    ["StatBuildings"] = "Edificios",
                    ["StatBuildingsSelected"] = "Edificio seleccionado",
                    ["StatTiles"] = "Baldosas",
                    ["StatNameNotFound"] = "No se ha encontrado el nombre del edificio",
                    ["UnknownObject"] = "Objeto desconocido",
                    ["PresetsLoaded"] = "Plantillas de edificio cargadas",
                    ["ExportImageSuccessful"] = "La imagen se ha exportado correctamente.",
                    ["ExportImageError"] = "Algo salió mal al exportar la imagen.",
                    ["ApplyColorToSelection"] = "Aplicar color",
                    ["ApplyColorToSelectionToolTip"] = "Aplicar el color a todos los edificios de la selección actual",
                    ["ApplyPredefinedColorToSelection"] = "Aplicar color predefinido",
                    ["ApplyPredefinedColorToSelectionToolTip"] = "Aplicar el color predefinido (si existe) a todos los edificios de la selección actual",
                    ["AvailableColors"] = "Colores disponibles",
                    ["StandardColors"] = "Colores predefinidos",
                    ["RecentColors"] = "Colores utilizados recientemente",
                    ["Standard"] = "Estándar",
                    ["Advanced"] = "Avanzado",
                    ["UpdateAvailableHeader"] = "Actualización disponible",
                    ["UpdateAvailablePresetMessage"] = $"Hay una versión actualizada del archivo de plantillas.{Environment.NewLine}¿Quieres descargarlo y reiniciar la aplicación?",
                    ["AdminRightsRequired"] = "Se requieren derechos de administrador",
                    ["UpdateRequiresAdminRightsMessage"] = "Para descargar la actualización, la aplicación necesita acceso de escritura. Por favor, proporciona tus credenciales.",
                    ["Error"] = "Error",
                    ["UpdateErrorPresetMessage"] = "Hubo un error al instalar la actualización.",
                    ["UpdateNoConnectionMessage"] = "No se ha podido establecer la conexión a Internet.",
                    ["ColorsInLayout"] = "Colores en el diseño",
                    ["ColorsInLayoutToolTip"] = "Doble clic en el color para seleccionarlo",
                    ["LoadLayoutHeader"] = "Cargar plantilla",
                    ["LoadLayoutMessage"] = "Pega la cadena JSON a continuación.",
                    ["ClipboardContainsLayoutAsJson"] = "El portapapeles contiene el diseño actual como JSON.",
                    ["OK"] = "OK",
                    ["Cancel"] = "Cancelar",
                    ["SelectAll"] = "Seleccionar todo",
                    ["Tools"] = "Herramientas",
                    ["Preferences"] = "Preferencias",
                    ["ResetAllConfirmationMessage"] = "¿Estás seguro de que quieres restablecer todas las teclas de acceso rápido a sus valores predeterminados?",
                    ["ResetAll"] = "Restablecer todo",
                    ["UpdateSettings"] = "Actualizar ajustes",
                    ["ManageKeybindings"] = "Gestionar las combinaciones de teclas",
                    ["Edit"] = "Editar",
                    ["Recording"] = "Registrando",
                    ["RecordANewAction"] = "Registar nueva acción",
                    ["Rotate"] = "Rotar",
                    ["Copy"] = "Copiar",
                    ["Paste"] = "Pegar",
                    ["Delete"] = "Eliminar",
                    ...
                    ["DeleteObjectUnderCursor"] = "Eliminar objetos bajo el cursor",
                    ["Licenses"] = "Licencias",
                    ["ViewLicenses"] = "Ver las licencias de código abierto",
                    ["ExternalLinkConfirmationMessage"] = "Esto abrirá una nueva pestaña en el navegador por defecto. ¿Continuar?",
                    ["ExternalLinkMessageTitle"] = "Abrir un enlace externo",
                    ["RecentFiles"] = "Archivos recientes",
                    ["UpdatePreferencesVersionInformation"] = "Información sobre la versión",
                    ["UpdatePreferencesSettings"] = "Ajustes",
                    ["UpdatePreferencesCheckPreRelease"] = "Comprobar si hay versiones preliminares",
                    ["UpdatePreferencesUpdates"] = "Actualizaciones",
                    ["UpdatePreferencesDownloadPresetsAndRestart"] = "Descargar plantillas y reiniciar la aplicación",
                    ["UpdatePreferencesNewAppUpdateAvailable"] = "¡Nueva actualización disponible! Echa un vistazo a la web para ver notas sobre la versión.",
                    ["UpdatePreferencesNoUpdates"] = "Esta versión está actualizada.",
                    ["UpdatePreferencesErrorCheckingUpdates"] = "Error al comprobar las actualizaciones.",
                    ["UpdatePreferencesMoreInfoInLog"] = "Se puede encontrar más información en el registro.",
                    ["UpdatePreferencesNewPresetsUpdateAvailable"] = "¡Hay disponible una nueva actualización de las plantillas!",
                    ["UpdatePreferencesBusyCheckUpdates"] = "Comprobando actualizaciones ...",
                    ["UpdatePreferencesBusyDownloadPresets"] = "Descargando plantillas ...",
                    ["NoIcon"] = "Sin icono",
                    ["GeneralSettings"] = "Ajustes generales",
                    ["GeneralPreferencesUISettings"] = "Ajustes de interfaz",
                    ["GeneralPreferencesHideInfluenceOnSelection"] = "Ocultar influencia en la selección",
                    ["GeneralPreferencesUseZoomToPoint"] = "Usar nuevo comportamiento del zoom",
                    ["GeneralPreferencesGridLinesColor"] = "Color de la cuadrícula",
                    ["GeneralPreferencesObjectBorderLinesColor"] = "Color del borde",
                    ["GeneralPreferencesZoomSensitivity"] = "Sensibilidad del zoom",
                    ["GeneralPreferencesInvertScrollingDirection"] = "Invertir dirección de desplazamiento",
                    ["GeneralPreferencesInvertPanningDirection"] = "Invertir el sentido de giro",
                    ["GeneralPreferencesShowScrollbars"] = "Mostrar barras de desplazamiento",
                    ["ColorTypeDefault"] = "Por defecto",
                    ["ColorTypeLight"] = "Luz",
                    ["ColorTypeCustom"] = "Personalizado",
                    ["Warning"] = "Advertencia",
                    ["FileNotFound"] = "No se ha encontrado el archivo.",
                    ["Default"] = "Por defecto",
                    ["ItemsCopied"] = "elementos copiados",
                    ["ItemCopied"] = "elemento copiado",
                    ["LoadingPresetsFailed"] = "La carga de las plantillas de los edificios ha fallado.",
                    ["LoadingIconNamesFailed"] = "La carga de los nombres de los iconos ha fallado.",
                    ["FileVersionUnsupportedMessage"] = $"¿Intentar cargar de todos modos?{Environment.NewLine}Es muy probable que esto falle o que ocurran cosas extrañas.",
                    ["FileVersionUnsupportedTitle"] = "Versión de archivo no admitida",
                    ["IOErrorMessage"] = "Algo salió mal al guardar/cargar el archivo.",
                    ["AnotherInstanceIsAlreadyRunning"] = "Ya se está ejecutando otra instancia de la aplicación.",
                    ["ErrorUpgradingSettings"] = "El archivo de configuración se ha corrompido. Es necesario restablecer la configuración.",
                    ["FileVersionMismatchMessage"] = $"¿Intentar cargar de todos modos?{Environment.NewLine}Es muy probable que esto falle o que ocurran cosas extrañas.",
                    ["FileVersionMismatchTItle"] = "Error en la versión del archivo",
                    ["LayoutLoadingError"] = "Algo ha ido mal al cargar el diseño.",
                    ["LayoutSavingError"] = "Algo salió mal al guardar el diseño.",
                    ["InvalidBuildingConfiguration"] = "Configuración del edificio no válida.",
                    ["MergeRoads"] = "Fusionar carreteras",
                    ["LoadingTreeLocalizationFailed"] = "La carga de la localización ha fallado.",
                    ["Undo"] = "Deshacer",
                    ["Redo"] = "Rehacer",
                    ["LayoutSettings"] = "Configuración del diseño",
                    ["View"] = "Ver",
                    ["SaveUnsavedChanges"] = "¿Guardar los cambios no guardados?",
                ...
                ["pol"] = new Dictionary<string, string>()
                {
                    ...
                    ["VersionCheckErrorMessage"] = $"Coś poszło nie tak podczas sprawdzania wersji Error.{Environment.NewLine}Więcej informacji można znaleźć w dzienniku. eksportowanie obrazu.",
                    ["VersionCheckErrorTitle"] = "Kontrola wersji nie powiodła się.",
                    ["EnableAutomaticUpdateCheck"] = "Włączyć automatyczne sprawdzanie aktualizacji przy uruchamianiu",
                    ["ContinueCheckingForUpdates"] = $"Czy chcesz kontynuować sprawdzanie nowej wersji przy starcie systemu?{Environment.NewLine}{Environment.NewLine}Opcja ta może zostać zmieniona poprzez Narzędzia -> Preferencje -> Ustawienia aktualizacji.",
                    ["ContinueCheckingForUpdatesTitle"] = "Kontynuować sprawdzanie pod kątem aktualizacji?",
                    ...
                    ["ExportImageError"] = "Coś poszło nie tak podczas eksportu obrazu.",
                    ...
                    ["DeleteObjectUnderCursor"] = "Usuń obiekt pod kursorem",
                    ["Licenses"] = "Licencje",
                    ...
                    ["View"] = "Zobacz",
                    ["SaveUnsavedChanges"] = "Zapisać niezapisane zmiany?",
                ...
                ["rus"] = new Dictionary<string, string>()
                {
                    ...
                    ["VersionCheckErrorMessage"] = $"Версия для проверки ошибок.{Environment.NewLine}Дополнительную информацию можно найти в журнале.",
                    ["VersionCheckErrorTitle"] = "Проверка версии не прошла.",
                    ["EnableAutomaticUpdateCheck"] = "Включить автоматическую проверку обновлений при запуске",
                    ["ContinueCheckingForUpdates"] = $"Хотите продолжить проверку новой версии при старте?{Environment.NewLine}{Environment.NewLine}Эту опцию можно изменить через Инструменты -> Параметры -> Обновить настройки.",
                    ["ContinueCheckingForUpdatesTitle"] = "Продолжать проверку обновлений?",
                    ...
                    ["ExportImageError"] = "Что-то пошло не так при экспорте изображения.",
                    ...
                    ["DeleteObjectUnderCursor"] = "Удалить объект под курсором",
                    ["Licenses"] = "Лицензии",
                    ...
                    ["View"] = "Посмотреть",
                    ["SaveUnsavedChanges"] = "Сохранить несохраненные изменения?",
                ...
                ["cn"] = new Dictionary<string, string>()
                {
                    ...
                    ["Save"] = "保存",
                    ["SaveAs"] = "另存为",
                    ["CopyLayoutToClipboard"] = "将布局复制为JSON到剪贴板",
                    ["LoadLayoutFromJson"] = "从JSON加载布局",
                    ["Exit"] = "退出",
                    ["Extras"] = "附加功能",
                    ["Normalize"] = "正常化",
                    ["ResetZoom"] = "重置缩放",
                    ["RegisterFileExtension"] = "注册文件扩展名",
                    ["RegisterFileExtensionSuccessful"] = "文件扩展名注册成功..",
                    ["UnregisterFileExtension"] = "注销文件扩展名",
                    ["UnregisterFileExtensionSuccessful"] = "文件扩展名注销成功..",
                    ["Successful"] = "成功",
                    ["Export"] = "导出",
                    ["ExportImage"] = "导出图像",
                    ["UseCurrentZoomOnExportedImage"] = "使用当前缩放导出图像",
                    ["RenderSelectionHighlightsOnExportedImage"] = "在导出的图像上高亮选中",
                    ["Language"] = "语言",
                    ["ManageStats"] = "管理统计",
                    ["ShowStats"] = "显示统计数据",
                    ["BuildingCount"] = "建筑计数",
                    ...
                    ["VersionCheckErrorMessage"] = $"版本检查错误。{Environment.NewLine}更多信息可以在日志中找到。",
                    ["VersionCheckErrorTitle"] = "检查更新失败",
                    ["EnableAutomaticUpdateCheck"] = "启用启动时自动更新检查",
                    ["ContinueCheckingForUpdates"] = $"是否要在启动时继续检查新版本？{Environment.NewLine}{Environment.NewLine}此选项可以通过工具->首选项->更新设置来更改。",
                    ["ContinueCheckingForUpdatesTitle"] = "继续检查更新？",
                    ["GoToProjectHomepage"] = "转到项目主页",
                    ["OpenWelcomePage"] = "打开欢迎页面",
                    ["AboutAnnoDesigner"] = "关于Anno Designer",
                    ["ShowGrid"] = "显示网格",
                    ["ShowLabels"] = "显示标签",
                    ["ShowIcons"] = "显示图标",
                    ["ShowTrueInfluenceRange"] = "显示真实影响范围",
                    ["ShowInfluences"] = "显示影响",
                    ...
                    ["PlaceBuilding"] = "放置建筑",
                    ["Search"] = "筛选",
                    ["SearchToolTip"] = "ESC清除搜索文本",
                    ["SearchPlaceholder"] = "在此处键入建筑的名称",
                    ["TitleAbout"] = "关于",
                    ["BuildingLayoutDesigner"] = "Ubisofts Anno 系列的建筑布局设计师",
                    ["Credits"] = "金融",
                    ["OriginalApplicationBy"] = "原始应用程序",
                    ["BuildingPresets"] = "建立预设",
                    ["CombinedForAnnoVersions"] = "组合建筑预设",
                    ["AdditionalChanges"] = "Github 上贡献者的其他更改",
                    ["ManyThanks"] = "非常感谢所有为这个项目做出贡献的用户！",
                    ["VisitTheFandom"] = "请务必访问 Anno 的 Fandom 页面！",
                    ["OriginalHomepage"] = "原主页",
                    ["ProjectHomepage"] = "项目主页",
                    ["GoToFandom"] = "去Fandom",
                    ["Close"] = "关闭",
                    ["StatusBarControls"] = "鼠标控制：左 - 放置、选择、移动 // 右 - 停止放置、移除 // 两者 - 全部移动 // 双击 - 复制 // 滚轮 - 缩放 // 滚轮点击 - 旋转..",
                    ["StatusBarItemsOnClipboard"] = "剪贴板上的项目",
                    ["StatNothingPlaced"] = "什么都没放",
                    ["StatBoundingBox"] = "边框",
                    ["StatMinimumArea"] = "最小面积",
                    ["StatSpaceEfficiency"] = "空间效率",
                    ["StatBuildings"] = "建筑",
                    ["StatBuildingsSelected"] = "建筑选择",
                    ["StatTiles"] = "瓷砖",
                    ["StatNameNotFound"] = "找不到建筑名称",
                    ["UnknownObject"] = "未知物体",
                    ["PresetsLoaded"] = "加载建筑预设",
                    ["ExportImageSuccessful"] = "图片导出成功",
                    ["ExportImageError"] = "导出图像时出了点问题..",
                    ["ApplyColorToSelection"] = "应用颜色",
                    ["ApplyColorToSelectionToolTip"] = "将颜色应用于当前选择中的所有建筑",
                    ["ApplyPredefinedColorToSelection"] = "应用预定义的颜色",
                    ["ApplyPredefinedColorToSelectionToolTip"] = "将预定义颜色（如果找到）应用于当前选择中的所有建筑",
                    ["AvailableColors"] = "可用颜色",
                    ["StandardColors"] = "预定义的颜色",
                    ["RecentColors"] = "最近使用的颜色",
                    ["Standard"] = "标准",
                    ["Advanced"] = "高级",
                    ["UpdateAvailableHeader"] = "更新可用",
                    ["UpdateAvailablePresetMessage"] = $"可以获得预设文件的更新版本。{Environment.NewLine}要下载它并重新启动应用程序吗？",
                    ["AdminRightsRequired"] = "需要管理员权限",
                    ["UpdateRequiresAdminRightsMessage"] = "要下载更新，应用程序需要写入权限 请提供凭据..",
                    ["Error"] = "错误",
                    ["UpdateErrorPresetMessage"] = "安装更新时出错",
                    ["UpdateNoConnectionMessage"] = "无法建立与互联网的连接",
                    ["ColorsInLayout"] = "布局中的颜色",
                    ["ColorsInLayoutToolTip"] = "双击选择颜色",
                    ["LoadLayoutHeader"] = "加载布局",
                    ["LoadLayoutMessage"] = "请粘贴下面的JSON字符串..",
                    ["ClipboardContainsLayoutAsJson"] = "剪贴板包含当前布局作为JSON..",
                    ["OK"] = "OK",
                    ["Cancel"] = "取消",
                    ["SelectAll"] = "全选",
                    ["Tools"] = "工具",
                    ["Preferences"] = "偏好",
                    ["ResetAllConfirmationMessage"] = "您确定要将所有热键重置为默认值吗？",
                    ["ResetAll"] = "重置所有",
                    ["UpdateSettings"] = "更新设置",
                    ["ManageKeybindings"] = "管理快捷键",
                    ["Edit"] = "编辑",
                    ["Recording"] = "记录",
                    ["RecordANewAction"] = "记录一个新动作",
                    ["Rotate"] = "旋转",
                    ["Copy"] = "复制",
                    ["Paste"] = "粘贴",
                    ["Delete"] = "删除",
                    ["Duplicate"] = "重复",
                    ["RotateAll"] = "全部旋转",
                    ["DeleteObjectUnderCursor"] = "删除光标下的对象",
                    ["Licenses"] = "许可证",
                    ["ViewLicenses"] = "查看开源许可证",
                    ["ExternalLinkConfirmationMessage"] = "这将在您的默认网络浏览器中打开一个新选项卡，继续？",
                    ["ExternalLinkMessageTitle"] = "打开外部链接",
                    ["RecentFiles"] = "最近的文件",
                    ["UpdatePreferencesVersionInformation"] = "版本信息",
                    ["UpdatePreferencesSettings"] = "设置",
                    ["UpdatePreferencesCheckPreRelease"] = "检查预发布",
                    ["UpdatePreferencesUpdates"] = "更新",
                    ["UpdatePreferencesDownloadPresetsAndRestart"] = "下载预设并重新启动应用程序",
                    ["UpdatePreferencesNewAppUpdateAvailable"] = "有新的更新可用！ 请查看网站以获取发行说明...",
                    ["UpdatePreferencesNoUpdates"] = "这个版本是最新的..",
                    ["UpdatePreferencesErrorCheckingUpdates"] = "检查更新时出错..",
                    ["UpdatePreferencesMoreInfoInLog"] = "更多信息可在日志中找到..",
                    ["UpdatePreferencesNewPresetsUpdateAvailable"] = "预设的新更新可用！",
                    ["UpdatePreferencesBusyCheckUpdates"] = "查询更新 ....",
                    ["UpdatePreferencesBusyDownloadPresets"] = "正在下载预设....",
                    ["NoIcon"] = "没有图标",
                    ["GeneralSettings"] = "常规设置",
                    ["GeneralPreferencesUISettings"] = "用户界面设置",
                    ["GeneralPreferencesHideInfluenceOnSelection"] = "隐藏对选择的影响",
                    ["GeneralPreferencesUseZoomToPoint"] = "使用新的缩放行为",
                    ["GeneralPreferencesGridLinesColor"] = "网格线颜色",
                    ["GeneralPreferencesObjectBorderLinesColor"] = "边框颜色",
                    ["GeneralPreferencesZoomSensitivity"] = "变焦灵敏度",
                    ["GeneralPreferencesInvertScrollingDirection"] = "反转滚动方向",
                    ["GeneralPreferencesInvertPanningDirection"] = "反转平移方向",
                    ["GeneralPreferencesShowScrollbars"] = "显示滚动条",
                    ["ColorTypeDefault"] = "默认",
                    ["ColorTypeLight"] = "光线",
                    ["ColorTypeCustom"] = "自定义",
                    ["Warning"] = "警告",
                    ...
                    ["ItemsCopied"] = "项目已复制",
                    ["ItemCopied"] = "项目已复制",
                    ["LoadingPresetsFailed"] = "加载建筑预设失败..",
                    ["LoadingIconNamesFailed"] = "加载图标名称失败..",
                    ["FileVersionUnsupportedMessage"] = $"试着加载？{Environment.NewLine}这很可能会失败或导致奇怪的事情发生。",
                    ["FileVersionUnsupportedTitle"] = "文件版本不受支持",
                    ["IOErrorMessage"] = "保存/加载文件时出了点问题..",
                    ["AnotherInstanceIsAlreadyRunning"] = "该应用程序的另一个实例已在运行..",
                    ["ErrorUpgradingSettings"] = "设置文件已损坏，我们必须重置您的设置..",
                    ["FileVersionMismatchMessage"] = $"试着加载？{Environment.NewLine}这很可能会失败或导致奇怪的事情发生。",
                    ["FileVersionMismatchTItle"] = "文件版本不匹配",
                    ["LayoutLoadingError"] = "加载布局时出了点问题..",
                    ["LayoutSavingError"] = "保存布局时出了点问题..",
                    ["InvalidBuildingConfiguration"] = "无效的建筑配置..",
                    ["MergeRoads"] = "合并道路",
                    ["LoadingTreeLocalizationFailed"] = "加载本地化失败..",
                    ["Undo"] = "撤消",
                    ["Redo"] = "重做",
                    ["LayoutSettings"] = "布局设置",
                    ["View"] = "视图",
                    ["SaveUnsavedChanges"] = "保存未保存的更改？",
                    ["UnsavedChanged"] = "有未保存的更改",
                    ["UnsavedChangedBeforeCrash"] = "程序崩溃但有未保存的更改",
                    ["ColorPresetsVersion"] = "颜色预设版本",
                    ["TreeLocalizationVersion"] = "树本地化版本",
                    ["ShowHarborBlockedArea"] = "显示港区",
                    ["ShowPanorama"] = "显示全景",
                    ["GeneralPreferencesRecentFilesSettings"] = "最近的文件设置",
                    ["GeneralPreferencesMaxRecentFiles"] = "最大最近文件",
                    ["Clear"] = "清除",
                    ["EnableDebugMode"] = "启用调试模式",
                    ["GeneralPreferencesIncludeRoadsInStatisticCalculation"] = "在统计中包括道路",
